...
Planteamiento: Dado un array de números y dos índices inicio y fin, encuentra el promedio 
de los elementos en el subarray que va desde el índice inicio hasta el índice fin (ambos inclusive).
...
const calculateAverage = (arr, start, end)=>{
    ...
    return subArray.reduce((acc,item)=> acc + item)/subArray.length
}
